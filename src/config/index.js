...
export const checkFollowUrl = (id) =>
  `${spotifyBaseUrl}/me/following/contains?type=artist&ids=${id}`;
...
export const checkPlaylistFollowUrl = (playlistId) =>
  `${spotifyBaseUrl}/playlists/${playlistId}/followers/contains`;
export const followPlaylistUrl = (playlistId) =>
  `${spotifyBaseUrl}/playlists/${playlistId}/followers`;
...
export const searchUrl = (search) =>
  `${spotifyBaseUrl}/search?q=${search}&type=album,track,artist,playlist`;
