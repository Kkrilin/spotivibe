...
export default function ArtistProfile({ index, gradientPairs, requiredArtist }) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: '14px', color: '#a1a1a1', fontWeight: 'bold' }}>
          Followers: {requiredArtist.followers && requiredArtist.followers.total}
        </span>
